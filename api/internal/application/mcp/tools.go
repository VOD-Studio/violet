...
type createPostArgs struct {
	...
	ShowSignature bool     `json:"show_signature,omitempty" jsonschema:"是否在文章正文末尾显示作者签名"`
}
...
type updatePostArgs struct {
	...
	Tags          []string `json:"tags,omitempty" jsonschema:"标签列表"`
	ShowSignature bool     `json:"show_signature,omitempty" jsonschema:"是否在文章正文末尾显示作者签名；省略或 false 表示隐藏"`
}
