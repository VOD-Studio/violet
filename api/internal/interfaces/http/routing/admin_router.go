...
func NewAdminRouter(d *Deps) chi.Router {
	...
	r.Route("/settings", func(sub chi.Router) {
		sub.Group(func(sub chi.Router) {
			...
			sub.Get("/security", settingsH.GetSecurity)
		...
		sub.Group(func(sub chi.Router) {
			...
			sub.Put("/security", settingsH.RequestSecurityChange)
			...
			sub.Post("/security/confirm", settingsH.ConfirmSecurityChange)
			sub.Delete("/security/pending", settingsH.CancelSecurityChange)
