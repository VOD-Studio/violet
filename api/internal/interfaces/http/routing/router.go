...
func registerNotePublicRoutes(v1 chi.Router, d *Deps) {
	noteH := d.Note
	v1.Route("/notes", func(r chi.Router) {
...
func registerPublicationRoutes(v1 chi.Router, d *Deps) {
...
func registerChatRoutes(v1 chi.Router, d *Deps) {
	...
	v1.Route("/chat", func(r chi.Router) {
		...
		r.With(d.SessionAuth).Patch("/conversations/{conversationId}/messages/{messageId}", h.EditMessage)
		r.With(d.SessionAuth).Get("/conversations/{conversationId}/messages/{messageId}/readers", h.MessageReaders)
