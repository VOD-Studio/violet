	...
	return createPortal(
		...
		>
			...
			<button
				type="button"
				onClick={close}
				className="flex h-8 w-8 items-center justify-center rounded-full border border-edge-hairline bg-background/80 backdrop-blur-md transition-colors hover:bg-foreground/10"
				aria-label="关闭"
			>
				<X className="size-4" />
			</button>
