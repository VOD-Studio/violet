...
// 来源: https://reactbits.dev (GitHub: DavidHDev/react-bits, MIT License)
// 变体: ts-tailwind | 拉取日期: 2026-06-17
//
// 文字解密动画组件，支持 hover/view/click 触发。基于 motion，无额外依赖。
...
export default function DecryptedText({
  ...
  const animateProps: Partial<HTMLMotionProps<"span">> =
