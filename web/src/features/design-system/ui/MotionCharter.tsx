			...
			<div>
				...
				<div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
					...
					<InteractiveCard
						...
						note="利用 CSS grid-template-rows 原生动画，无须 JS 测高，高度丝滑伸展。"
						usage="<SmoothExpand open={isOpen}>{children}</SmoothExpand>"
					>
						<div className="w-64 rounded-lg border border-border/40 bg-card p-3">
							<button
								type="button"
							...
							<SmoothExpand open={expandOpen} className="mt-1">
								<p className="pt-2 text-xs leading-relaxed text-muted-foreground border-t border-border/30">
