 ...
 * 工具方言下主要动作是中性色，当前导航的指示条用品牌强调色保持品牌连续性 */
export const NAV_ITEM_ACTIVE =
	"bg-accent text-accent-foreground before:absolute before:left-0 before:top-1/2 before:h-4 before:w-0.5 before:-translate-y-1/2 before:rounded-full before:bg-brand before:content-['']";
