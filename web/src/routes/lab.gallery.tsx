	...
	return (
		<div className="container mx-auto px-6 py-4">
			...
			<section className="mb-24">
				<h2 className="mb-2 text-2xl font-semibold">浏览流 · 四方向</h2>
			...
			{/* ============ 详情网格（灯箱复用生产 ImagePreview） ============ */}
			<section>
				<h2 className="mb-2 text-2xl font-semibold">详情网格 · 三方向</h2>
				<p className="mb-8 text-sm text-muted-foreground">
					只选网格——灯箱直接用生产 ImagePreview（←/→ 导航、Esc 关闭、缩放旋转），
					点击网格任意项打开。 mock 是 14 项摄影集：横竖方混排 + 2
					个视频（灯箱内展示封面帧） + 空与长 caption 样本。
				</p>
				<div className="mb-6 flex flex-wrap items-center justify-between gap-4">
					<Segmented
						value={grid}
			...
			<ImagePreview
				...
				images={MOCK_GALLERY.items.map((it) => it.url)}
