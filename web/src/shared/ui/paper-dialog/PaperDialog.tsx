...
/**
 * 宽版报纸中缝摊平与折叠收拢动效：
 * - 展开（280ms）：从中缝对折线向左右两侧行云流水般减速摊平展开（Deceleration）；
 * - 收拢（180ms）：顺势加速向内微折并平滑淡出（Acceleration），干脆利落，毫不拖沓。
 */
export const PAPER_MOTION_SPREAD: ModalContentMotion = {
	initial: {
		opacity: 0,
 ...
 *
 * 提供拟真手撕纯白/暗夜毛边、立体漫反射纸影与宽版报纸中缝摊开动效，
...
export function PaperDialog({
	...
	return (
		<Modal
			...
			contentMotion={reduceMotion ? REDUCED_DIALOG_MOTION : PAPER_MOTION_SPREAD}
			className={cn(
